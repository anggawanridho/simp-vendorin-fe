...
const DashboardSideBar = () => {
  return (
    <div className="md:flex md:flex-col md:gap-4 md:w-72 shadow-lg text-custom-color-dashboard">
      ...
      <ul className="md:flex md:flex-col gap-2 md:px-4">
        <li>
          <Link href="/dashboard" className="flex flex-row rounded-lg p-4 gap-4 hover:bg-blue-500 transition-colors duration-300">
